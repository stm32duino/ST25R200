...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200WaitAgd(void)
{
  uint32_t ts;
...
ReturnCode RfalRfST25R200Class::st25r200Initialize(void)
{
  ReturnCode ret;
  ...
  timerDelay(ST25R200_RESET_DUR);
  digitalWrite(ST25R_RESET_PIN, LOW);
  timerDelay(ST25R200_RESET_DUR);
...
/*******************************************************************************/
void RfalRfST25R200Class::st25r200Deinitialize(void)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200OscOn(void)
{
  ReturnCode ret;
  uint8_t    reg;
  ...
  if ((reg & ST25R200_REG_DISPLAY1_agd_ok) != ST25R200_REG_DISPLAY1_agd_ok) {
    EXIT_ON_ERR(ret, st25r200WaitAgd());
  }
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200AdjustRegulators(uint8_t drop, uint16_t *result)
{
  uint8_t res;
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200ExecuteCommandAndGetResult(uint8_t cmd, uint8_t resReg, uint8_t tOut, uint8_t *result)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200MeasureIQ(int8_t *resI, int8_t *resQ)
{
  ReturnCode ret;
  uint8_t    aux;

  EXIT_ON_ERR(ret, st25r200ExecuteCommandAndGetResult(ST25R200_CMD_MEASURE_IQ, 0, ST25R200_TOUT_MEASUREMENT, NULL));
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200MeasureCombinedIQ(uint8_t *res)
{
  ReturnCode ret;
  uint8_t    I;
  uint8_t    Q;
  ...
  EXIT_ON_ERR(ret, st25r200CalibrateWU(&I, &Q));
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200ClearCalibration(void)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200CalibrateWU(uint8_t *resI, uint8_t *resQ)
{
  ReturnCode ret;

  EXIT_ON_ERR(ret, st25r200ExecuteCommandAndGetResult(ST25R200_CMD_CALIBRATE_WU, 0, ST25R200_TOUT_MEASUREMENT, NULL));
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200MeasureWU(uint8_t *resI, uint8_t *resQ)
{
  ReturnCode ret;

  EXIT_ON_ERR(ret, st25r200ExecuteCommandAndGetResult(ST25R200_CMD_MEASURE_WU, 0, ST25R200_TOUT_MEASUREMENT, NULL));
...
/*******************************************************************************/
bool RfalRfST25R200Class::st25r200IsExtFieldOn(void)
{
  uint8_t val;
  uint8_t reg;
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200SetBitrate(uint8_t txRate, uint8_t rxRate)
{
  uint8_t reg;
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200PerformCollisionAvoidance(void)
{
#if 1
  /*******************************************************************************/
...
/*******************************************************************************/
void RfalRfST25R200Class::st25r200SetNumTxBits(uint16_t nBits)
{
...
/*******************************************************************************/
uint16_t RfalRfST25R200Class::st25r200GetNumFIFOBytes(void)
{
  uint8_t  reg;
  uint16_t result;
...
/*******************************************************************************/
uint8_t RfalRfST25R200Class::st25r200GetNumFIFOLastBits(void)
{
  uint8_t  reg;
...
/*******************************************************************************/
uint32_t RfalRfST25R200Class::st25r200GetNoResponseTime(void)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200SetNoResponseTime(uint32_t nrt)
{
  ReturnCode err;
  uint8_t    nrt_step;
  uint32_t   tmpNRT;
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200SetStartNoResponseTimer(uint32_t nrt)
{
  ReturnCode err;
...
/*******************************************************************************/
void RfalRfST25R200Class::st25r200SetGPTime(uint16_t gpt)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200SetStartGPTimer(uint16_t gpt, uint8_t trigger)
{
...
/*******************************************************************************/
bool RfalRfST25R200Class::st25r200CheckChipID(uint8_t *rev)
{
  uint8_t ID;
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200GetRegsDump(uint8_t *resRegDump, uint8_t *sizeRegDump)
{
  uint8_t regIt;
  ...
  for (regIt = ST25R200_REG_OPERATION; regIt < SIZEOF_ARRAY(regDump); regIt++) {
...
/*******************************************************************************/
bool RfalRfST25R200Class::st25r200IsCmdValid(uint8_t cmd)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R200Class::st25r200SetAntennaMode(bool single, bool rfiox)
{
  uint8_t val;
